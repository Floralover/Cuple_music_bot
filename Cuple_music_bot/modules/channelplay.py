...
from Cuple_music_bot.modules.play import generate_cover
from Cuple_music_bot.modules.play import arq
from Cuple_music_bot.modules.play import cb_admin_check
from Cuple_music_bot.modules.play import transcode
from Cuple_music_bot.modules.play import convert_seconds
from Cuple_music_bot.modules.play import time_to_seconds
from Cuple_music_bot.modules.play import changeImageSize
from Cuple_music_bot.config import BOT_NAME as bn
from Cuple_music_bot.config import DURATION_LIMIT
from Cuple_music_bot.config import UPDATES_CHANNEL as updateschannel
from Cuple_music_bot.config import que
from Cuple_music_bot.function.admins import admins as a
from Cuple_music_bot.helpers.errors import DurationLimitError
from Cuple_music_bot.helpers.decorators import errors
from Cuple_music_bot.helpers.admins import get_administrators
from Cuple_music_bot.helpers.channelmusic import get_chat_id
from Cuple_music_bot.helpers.decorators import authorized_users_only
from Cuple_music_bot.helpers.filters import command
from Cuple_music_bot.helpers.filters import other_filters
from Cuple_music_bot.helpers.gets import get_file_name
from Cuple_music_bot.services.callsmusic import callsmusic
from Cuple_music_bot.services.callsmusic import client as USER
from Cuple_music_bot.services.converter.converter import convert
from Cuple_music_bot.services.downloaders import youtube
from Cuple_music_bot.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/35db9f6a2f369decce84b.jpg"
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @Cuple_music_bot to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
